...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div x-cloak x-show="open" class="sm:hidden">
        {{-- Backdrop --}}
        <div x-show="open" x-transition.opacity class="fixed inset-0 bg-black/40 z-40" @click="open=false" aria-hidden="true"></div>
        ...
        <aside x-show="open"
               ...
               class="fixed right-0 top-0 bottom-0 z-50 w-80 max-w-[90%] bg-white shadow-xl border-s"
